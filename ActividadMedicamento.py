...
btn_registrar = ttk.Button(btn_frame, text="Registrar Medicamento", command= registrarMedicamento)
btn_registrar.grid(row=0, column=0, padx=5, pady=5, sticky="ew")
 
btn_eliminar = ttk.Button(btn_frame, text="Eliminar Medicamento", command=eliminar_medicamento)
btn_eliminar.grid(row=0, column=1, padx=5, pady=5, sticky="ew")
#crear treeview para mostrar
treeview=ttk.Treeview(form_frame, columns=("Nombre", "Dosis","Fecha"), show="headings")
