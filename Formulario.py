...
fechaN=ttk.Entry(frame_pacientes, validate="key", validatecommand=(validacion_fecha, '%P'))#llamado a la funcion de enmascarar fecha
...
comboCentroMedico=ttk.Combobox(frame_pacientes, values=["Hospital Centra", "Clinica Norte", "Centro Sur"], textvariable=centro_medico)
