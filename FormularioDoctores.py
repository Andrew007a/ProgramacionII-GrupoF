...
#años de experiencia
labelAñosExp=tk.Label(frame_doctores, text="Años de Experiencia")
labelAñosExp.grid(row=2,column=0, padx=5, pady=5, sticky="w")
...
comboHospital=ttk.Combobox(frame_doctores, values=["San Juan De Dios", "Francés","Japonés"], textvariable=hospital)
